...
총 60분. 콘텐츠 55분 + Q&A 5분.

| 섹션 | 시간 | 내용 |
|---|---|---|
| Hero — 후킹 | 2분 | "1주일 걸리던 일을 1시간 만에 직접 보세요" |
| §1 Claude Code란? + 지금 왜 봐야 하나 | 4분 | 한 줄 정의, 타임라인 영상, 변곡점 3개 |
| §2 핵심 기능 투어 | 12분 | 오늘 바로 쓸 3개 + 나중에 붙일 2개 |
| §3 임베디드 라이브 데모 (U-Boot) | 24분 | A 분석 / C 빌드 / E 단위테스트 / H 문서화, 각 6분 |
| §4 효과 — 생산성과 검토 품질 | 6분 | Before/After, 시간 절감 차트, 워크플로우 변화, 역할별 체감 |
| §5 시작하기 + 다음 7일 | 7분 | 설치 영상, CLAUDE.md 템플릿, 첫 30분, 7일 플랜 |
| Q&A | 5분 | 페이지 끝 FAQ 6문답 + 라이브 |
