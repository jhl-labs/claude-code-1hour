...
const faqs: FAQ[] = [
  ...
  {
    tag: "보안",
    q: "완전 오프라인·사내망 격리 환경에서도 쓸 수 있나요?",
    a: "완전 오프라인은 불가(API 호출 필요). 다만 사내 프록시 한 곳으로 트래픽을 모으고, 도메인 화이트리스트(api.anthropic.com)·TLS 검사·감사 로그를 거치게 하면 일반적인 NDA 환경에서 운영 가능. 망분리 환경은 별도 검토 필요.",
  },
  {
    tag: "비교",
