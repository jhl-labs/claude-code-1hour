...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    a: "코드 탐색·변경 초안·테스트 설계·문서화에 활용할 수 있습니다. MMIO·IRQ·DMA·실시간성은 코드 설명만으로 검증되지 않습니다. 실제 시연은 U-Boot 소스 분석·ARM object 컴파일·ECC 포장 테스트·문서화를 보여줍니다. NAND 하드웨어 동작은 보드에서 따로 검증해야 합니다.",
  },
  {
    tag: "검증",
